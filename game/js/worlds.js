...
const WORLDS = [
  {
    ...
    music: { root: 50, bpm: 86, prog: [C.I, C.V, C.vi, C.IV], padCut: 1100, padVol: 0.05,
      arp: [0, 1, 2, 3, 4, 5, 6, 5, 4, 3, 2, 1, 2, 3, 4, 5], arpEvery: 1, arpWave: 'triangle', arpVol: 0.035, arpDec: 0.35, arpIntroBars: 1,
      bass: [0, 6, 10], bassVol: 0.15, kick: [0, 8], kickVol: 0.22, hat: [4, 12], drumIn: 4, lead: LEAD_A, leadVol: 0.05, leadIn: 8 },
  },
  {
    ...
    music: { root: 57, bpm: 78, prog: [C.vi, C.IV, C.I, C.V], padCut: 900, padVol: 0.05, padWave: 'sawtooth',
      arp: [0, 2, 4, 6, 4, 2], arpEvery: 2, arpWave: 'sine', arpVol: 0.05, arpDec: 1.1,
      bass: [0, 8], bassLen: 6, lead: LEAD_B, leadType: 'bell', leadVol: 0.045, leadIn: 4, shimmer: true, kick: [0], kickVol: 0.15, drumIn: 8 },
  },
  {
    ...
    music: { root: 53, bpm: 92, prog: [C.IV, C.V, C.iii, C.vi], padCut: 1400, padVol: 0.05,
      arp: [0, 1, 2, 3, 4, 3, 2, 1], arpEvery: 1, arpWave: 'sine', arpVol: 0.04, arpDec: 0.5,
      bass: [0, 3, 8, 11], bassVol: 0.14, bassLen: 2, kick: [0, 6, 8], kickVol: 0.24, hat: [2, 6, 10, 14], drumIn: 4, lead: LEAD_C, leadVol: 0.05, leadIn: 8, shimmer: true },
  },
  {
    ...
    music: { root: 50, bpm: 70, prog: [C.I, C.iii, C.IV, C.iv], padCut: 800, padVol: 0.055, padWave: 'triangle',
      arp: [0, 2, 4, 5, 6, 5, 4, 2], arpEvery: 2, arpWave: 'sine', arpVol: 0.05, arpDec: 1.2,
      bass: [0], bassLen: 14, lead: LEAD_B, leadType: 'bell', leadVol: 0.04, leadIn: 4, shimmer: true },
  },
  {
    ...
    music: { root: 52, bpm: 104, prog: [C.vi, C.V, C.IV, C.V], padCut: 1300, padVol: 0.05,
      arp: [0, 3, 4, 3, 1, 3, 4, 3], arpEvery: 1, arpWave: 'sawtooth', arpVol: 0.02, arpDec: 0.25,
      bass: [0, 3, 6, 8, 11, 14], bassVol: 0.16, bassLen: 2, kick: [0, 4, 8, 12], kickVol: 0.3, hat: [2, 6, 10, 14], hatVol: 0.035, drumIn: 2, lead: LEAD_C, leadVol: 0.055, leadIn: 4 },
  },
  {
    ...
    music: { root: 55, bpm: 96, prog: [C.IV, C.V, C.vi, C.I], padCut: 1500, padVol: 0.05,
      arp: [0, 1, 2, 3, 4, 5, 6, 7, 8, 7, 6, 5, 4, 3, 2, 1], arpEvery: 1, arpWave: 'triangle', arpVol: 0.03, arpDec: 0.4,
      bass: [0, 6, 8, 14], bassVol: 0.15, kick: [0, 8, 10], kickVol: 0.26, hat: [4, 12], drumIn: 4, lead: LEAD_A, leadType: 'bell', leadVol: 0.055, leadIn: 4, shimmer: true },
  },
];
