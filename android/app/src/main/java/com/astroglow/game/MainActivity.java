...
/**
 * Contenedor nativo del juego: un WebView a pantalla completa que sirve
 * el juego HTML5 desde los assets del APK (funciona sin conexión).
 */
public class MainActivity extends Activity {
    ...
    public void onBackPressed() {
        webView.evaluateJavascript("(window.onAndroidBack && window.onAndroidBack()) ? 'y' : 'n'", value -> {
